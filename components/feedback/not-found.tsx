...
const containerClass = "min-h-[calc(100vh-var(--navbar-height)-var(--primary-offset)*2)] flex items-center justify-center";
...
const linkClass = "inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-red-600 hover:bg-red-700 font-semibold shadow-md transition focus:outline-none focus:ring-2 focus:ring-red-400 text-red-900";
